// Room Manager Service: Handles room tracking, updates, and scene integration
// Provides high-level room management functionality
...
export function createRoomManager({ THREE, scene, roomSystem, persistence }) {
  ...
  function onRoomModified(room, oldData = null) {
    ...
    emitEvent('roomModified', { room, oldData });
    scheduleAutosave();
  }
